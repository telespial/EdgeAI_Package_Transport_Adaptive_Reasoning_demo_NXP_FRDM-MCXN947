...
void BOARD_InitPins(void)
{
    ...
    /* On-board temperature path uses I3C1 pins (SDA/SCL/PUR). */
    const port_pin_config_t i3c1_pur_cfg = {
        .pullSelect = kPORT_PullDisable,
        .pullValueSelect = kPORT_LowPullResistor,
        .slewRate = kPORT_FastSlewRate,
        .passiveFilterEnable = kPORT_PassiveFilterDisable,
    ...
    const port_pin_config_t i3c1_data_clk_cfg = {
        .pullSelect = kPORT_PullUp,
        .pullValueSelect = kPORT_LowPullResistor,
        .slewRate = kPORT_FastSlewRate,
        .passiveFilterEnable = kPORT_PassiveFilterDisable,
        .openDrainEnable = kPORT_OpenDrainDisable,
        .driveStrength = kPORT_LowDriveStrength,
        .mux = kPORT_MuxAlt10, /* I3C1_SDA / I3C1_SCL */
        .inputBuffer = kPORT_InputBufferEnable,
        .invertInput = kPORT_InputNormal,
        .lockRegister = kPORT_UnlockRegister,
    };
    PORT_SetPinConfig(PORT1, 11U, &i3c1_pur_cfg);      /* I3C1_PUR */
    PORT_SetPinConfig(PORT1, 16U, &i3c1_data_clk_cfg); /* I3C1_SDA */
    PORT_SetPinConfig(PORT1, 17U, &i3c1_data_clk_cfg); /* I3C1_SCL */

    /* On-board external NOR flash (W25Q64) on FLEXSPI0. */
    const port_pin_config_t flexspi_cfg = {
        .pullSelect = kPORT_PullDisable,
        .pullValueSelect = kPORT_LowPullResistor,
        .slewRate = kPORT_FastSlewRate,
        .passiveFilterEnable = kPORT_PassiveFilterDisable,
    ...
    const port_pin_config_t flexspi_data23_cfg = {
        .pullSelect = kPORT_PullUp,
        .pullValueSelect = kPORT_LowPullResistor,
        .slewRate = kPORT_FastSlewRate,
        .passiveFilterEnable = kPORT_PassiveFilterDisable,
    ...
    PORT_SetPinConfig(PORT3, 0U, &flexspi_cfg);   /* SS0 */
    PORT_SetPinConfig(PORT3, 6U, &flexspi_cfg);   /* DQS */
    PORT_SetPinConfig(PORT3, 7U, &flexspi_cfg);   /* SCLK */
    PORT_SetPinConfig(PORT3, 8U, &flexspi_cfg);   /* DATA0 */
    PORT_SetPinConfig(PORT3, 9U, &flexspi_cfg);   /* DATA1 */
    PORT_SetPinConfig(PORT3, 10U, &flexspi_data23_cfg); /* DATA2 */
    PORT_SetPinConfig(PORT3, 11U, &flexspi_data23_cfg); /* DATA3 */
    PORT_SetPinConfig(PORT3, 12U, &flexspi_cfg);  /* DATA4 */
    PORT_SetPinConfig(PORT3, 13U, &flexspi_cfg);  /* DATA5 */
    PORT_SetPinConfig(PORT3, 14U, &flexspi_cfg);  /* DATA6 */
    PORT_SetPinConfig(PORT3, 15U, &flexspi_cfg);  /* DATA7 */
}
